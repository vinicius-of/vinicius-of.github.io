...
const AboutPortfolioIcon = () => {
    return (
        ...
        >
            <g>
                <path
                    d="M360.082,175.411l-82.42-57.744c-1.413-0.99-2.725-1.514-4.249-1.514c-3.307,0-6.413,2.512-6.413,7.313v34.323H161.436
       ...
       C363.579,179.335,362.296,176.962,360.082,175.411z"
                />
                <path
                    d="M297.943,261.789c-1.384,0-2.678,1.072-2.698,1.092l-20.005,14.014c-0.173,0.114-4.24,2.852-4.24,7.896
